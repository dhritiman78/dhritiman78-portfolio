    ...
    <div className="min-h-screen mt-16 bg-gray-100">
        ...
        <header className="bg-blue-900 text-white py-6 shadow-lg">
            <div className="container mx-auto px-4 text-center">
                ...
                <p className="mt-2">Showcasing the work I've done over the years</p>
            </div>
        </header>
        ...
        <section className="container mx-auto px-4 py-12 ">
            ...
            {projects.map((project, index) => (
                ...
                >
                    <h2 className="text-xl font-bold text-pink-600">{project.name}</h2>
                    <p className="text-gray-600 mt-2">{project.description}</p>
                    <div className="mt-4 flex flex-wrap items-center">
                        <span className="text-sm mr-2 font-semibold text-gray-500">Role:</span>
                        <span className="text-sm font-semibold text-blue-600">{project.role}</span>
                    </div>
                    <div className="mt-2 flex flex-wrap items-center">
                        <span className="text-sm mr-2 font-semibold text-gray-500">Technologies:</span>
                        <span className="text-sm text-blue-600">{project.technologies}</span>
                    </div>
                    <a
                        href={project.github}
                        className="mt-4 inline-block hover:text-blue-800 transition-colors duration-300"
                        target="_blank"
